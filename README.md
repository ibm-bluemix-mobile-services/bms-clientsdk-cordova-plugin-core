...
The Android development environment does not require additional configuration. You can open the Android Project that is generated by Cordova in the `[your-app-name]/platforms/android` directory with Android Studio, or use the Cordova CLI to build and run your project.
