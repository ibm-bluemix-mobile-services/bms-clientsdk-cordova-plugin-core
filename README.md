...
- Include the IMFCore framework:
    <ol>
        ...
        <li>Download IFMCore.framework from the <a href="https://hub.jazz.net/project/bluemixmobilesdk/imf-ios-sdk/overview#https://hub.jazz.net/git/bluemixmobilesdk%252Fimf-ios-sdk/list/master/Frameworks/IMFCore.framework">SDK repository</a> and copy it to the Frameworks folder</li>
    </ol>
